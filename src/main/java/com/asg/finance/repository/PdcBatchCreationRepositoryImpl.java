...
public class PdcBatchCreationRepositoryImpl implements PdcBatchCreationRepository{
    ...
    private static final String P_PAY_GL_POID = "P_PAY_GL_POID";
    private static final String P_PRE_PRINTED = "P_PRE_PRINTED";
    private static final String P_START_CHQ_NO = "P_START_CHQ_NO";
    private static final String P_NO_OF_CHQ = "P_NO_OF_CHQ";
    private static final String P_STATUS = "P_STATUS";
    private static final String P_BILL_REF = "P_BILL_REF";
    private static final String P_LOGIN_USER = "P_LOGIN_USER";
    private static final String P_CHQ_AMT = "P_CHQ_AMT";
    private static final String P_NARRATION = "P_NARRATION";
