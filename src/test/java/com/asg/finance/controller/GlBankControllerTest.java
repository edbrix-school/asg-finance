...
class GlBankControllerTest {
    ...
    void createNewEntry_MissingRequiredParams() throws Exception {
        when(bankService.createEntry(any(GlBankDto.class))).thenReturn(null);
    ...
    void listOfRecordsWithGenericSearch_WithFilters_ShouldReturnRecords() throws Exception {
        ...
        when(bankService.listOfRecordsAndGenericSearch(any(), any(FilterRequestDto.class), any(Pageable.class)))
        ...
        verify(bankService, times(1))
                .listOfRecordsAndGenericSearch(any(), any(FilterRequestDto.class), any(Pageable.class));
    }
    ...
    void listOfRecordsWithGenericSearch_WhenDocumentIdMissing_ShouldReturnInternalServerError() throws Exception {
        ...
        verify(bankService).listOfRecordsAndGenericSearch(any(), any(FilterRequestDto.class), any(Pageable.class));
    }
