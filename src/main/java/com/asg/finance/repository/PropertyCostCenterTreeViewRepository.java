...
/**
 * Repository class for Property Cost Center Tree View operations
 * Handles database procedure calls for tree structure retrieval
 * Uses PROC_GLOB_DOC_TREEVIEW_LOAD with document ID 400-013
 */
@Repository
@Slf4j
public class PropertyCostCenterTreeViewRepository {

    @Autowired
    private DataSource dataSource;

    /**
     * Call the Property Cost Center tree view procedure
     *
     ...
     */
    public List<Map<String, Object>> callPropertyCostCenterTreeViewProcedure(String documentId, String actionRequested, PropertyCostCenterTreeRequest request) throws SQLException {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            log.debug("Calling PROC_GLOB_DOC_TREEVIEW_LOAD for Property Cost Center tree with documentId: {}, actionRequested: {}",
                ...
                if (rs != null) {
                    ...
                    while (rs.next()) {
                        ...
                        if (treeViewData.size() <= 3) {
                            log.debug("Record {}: LVL={}, POID={}, DESCRIPTION={}, PARENT_POID={}, ITEM_TYPE={}, GL_TYPE={}, CODE={}",
                                    treeViewData.size(),
                                    record.get("LVL"),
                                    record.get("POID"),
            ...
            log.debug("PROC_GLOB_DOC_TREEVIEW_LOAD returned {} records for Property Cost Center tree", treeViewData.size());
