...
class TaxMasterControllerTest {
    ...
    void testCreateTaxMaster_Success() throws Exception {
        ...
        mockMvc.perform(post("/v1/tax-master")
                ...
                .andExpect(jsonPath("$.result.data.taxPoid").value(2001))
                .andExpect(jsonPath("$.result.data.taxCode").value("TAX123"))
                .andExpect(jsonPath("$.result.data.taxName").value("VAT"));

        verify(taxMasterServiceImpl, times(1)).createTaxMaster(any(TaxMasterRequestDTO.class));
    }
    ...
    void testUpdateTaxMaster_Success() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/tax-master/{taxPoid}", 2001L)
                        .param("documentId", "doc-123")
        ...
        verify(taxMasterServiceImpl, times(1)).updateTaxMaster(eq(2001L), any(TaxMasterRequestDTO.class));
    }
    ...
    void testGetTaxMaster_Success() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/tax-master/{taxPoid}", 2001L)
                        .param("documentId", "doc-123")
        ...
        verify(taxMasterServiceImpl, times(1)).getTaxMasterById(2001L);
    }
    ...
    void testSoftDeleteTaxMaster_Success() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/tax-master/{taxPoid}", 2001L)
                        .param("documentId", "doc-123")
                        .param("actionRequested", "delete"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.success").value(true));

        verify(taxMasterServiceImpl, times(1)).softDeleteTaxMaster(2001L);
    }
    ...
    void testListTaxMaster_Success() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/tax-master/list")
                        .param("documentId", "doc-123")
                        .param("actionRequested", "VIEW")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void testCreateTaxMaster_MissingDocumentId() throws Exception {
        mockMvc.perform(post("/api/v1/tax-master")
                        .param("actionRequested", "create")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(requestDto)))
                .andExpect(status().isInternalServerError());
    ...
    void testUpdateTaxMaster_InvalidId() throws Exception {
        mockMvc.perform(put("/api/v1/tax-master/{taxPoid}", "invalid")
                        .param("documentId", "doc-123")
                        .param("actionRequested", "update")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(requestDto)))
    ...
    void testUpdateTaxMaster_NegativeId() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/tax-master/{taxPoid}", -1L)
                        .param("documentId", "doc-123")
                        .param("actionRequested", "update")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(requestDto)))
    ...
    void testUpdateTaxMaster_ZeroId() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/tax-master/{taxPoid}", 0L)
                        .param("documentId", "doc-123")
                        .param("actionRequested", "update")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(requestDto)))
    ...
    void testGetTaxMaster_InvalidId() throws Exception {
        mockMvc.perform(get("/api/v1/tax-master/{taxPoid}", "invalid")
                        .param("documentId", "doc-123")
                        .param("actionRequested", "view"))
                .andExpect(status().isBadRequest());
    }
    ...
    void testGetTaxMaster_NegativeId() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/tax-master/{taxPoid}", -1L)
                        .param("documentId", "doc-123")
                        .param("actionRequested", "view"))
                .andExpect(status().isOk());
    }
    ...
    void testGetTaxMaster_ZeroId() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/tax-master/{taxPoid}", 0L)
                        .param("documentId", "doc-123")
                        .param("actionRequested", "view"))
                .andExpect(status().isOk());
    }
    ...
    void testSoftDeleteTaxMaster_InvalidId() throws Exception {
        mockMvc.perform(delete("/api/v1/tax-master/{taxPoid}", "invalid")
                        .param("documentId", "doc-123")
                        .param("actionRequested", "delete"))
                .andExpect(status().isBadRequest());
    }
